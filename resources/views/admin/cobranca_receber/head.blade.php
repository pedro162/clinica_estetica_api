		...
		<div class="row">
			<div class="col-md-12">	
				<nav aria-label="breadcrumb" class="my-2">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="{{route('receber.index')}}">Inicio</a></li>
						<li class="breadcrumb-item desable" aria-current="page"><a >Lista de contas a receber</a></li>
					</ol>
				</nav>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		@php 
			...
			if(! isset($modifyUrlTitle)){
				...
				@endphp
					Utilitarios.modifyUrlWithoutReload('/receber/head', 'Contas a receber')
				@php
			}
		@endphp
		...
		function cadastrar{{$randId}}(element){
			try{
				...
				Utilitarios.assistentAjaxModal('POST',url, 'HTML','Contas a receber - Cadastrar', 'sm', '300px', null, data)
				//Utilitarios.toggleFiltro();
			}catch(ex){
