	...
	<div class="row">
		<div class="col-md-12">	
			<nav aria-label="breadcrumb" class="my-2">
				<ol class="breadcrumb">
					<li class="breadcrumb-item active"><a href="{{route('conta.index')}}">Inicio</a></li>
					<li class="breadcrumb-item desable" aria-current="page"><a >Lista de contas</a></li>
				</ol>
			</nav>
		</div>
	</div>
...
<script type="text/javascript">
	...
	@php 
		...
		if(! isset($modifyUrlTitle)){
			...
			@endphp
				Utilitarios.modifyUrlWithoutReload('/conta/head', 'Caixas')
			@php
		}
	@endphp
	...
	function cadastrar{{$randId}}(element){
		try{
			...
			Utilitarios.assistentAjaxModal('POST',url, 'HTML','Conta - Cadastrar', 'sm', '300px', null, data)
			//Utilitarios.toggleFiltro();
		}catch(ex){
