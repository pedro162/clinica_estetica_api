	...
	<div class="col-md-12 col-sm-12 "  >
			...
			<div class="col-md-12 col-sm-12">
				<table class="table table-responsive table-hover" style="width: 100%;">
					<tbody>
						<tr>
							<td>Descrição:</td>
							<td>{{$registro->nmPais ? $registro->nmPais : ''}}</td>
						</tr>
						<tr>
							<td>Código do país:</td>
							<td>{{$registro->cdPais ? $registro->cdPais : ''}}</td>
						</tr>
						<tr>
							<td>Definoido como padrão:</td>
							<td>{{$registro->padrao == 'yes' ? 'Sim' : 'Não'}}</td>
						</tr>
						<tr>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12" align="right">
				<a id="id_produto_destroy" onClick="destroy(this);" href="{{route('pais.destroy', $registro->id)}}" class="btn btn-sm btn-danger">Deletar</a>
			</div>
		</div>
	</div>
</div>
