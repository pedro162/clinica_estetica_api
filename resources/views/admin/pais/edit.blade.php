...
<div class="container">
	<div class="row">
		<div class="col">
			<form action="{{route('pais.update', $registro->id)}}" method="post" class="form" id="form_{{$randId}}" enctype="multipart/form-data">
				@csrf
				@method('PUT')
				...
				<div  class="row" >
					<div class="form-group col-md-12 col-sm-12">
						...
						<input value="{{$registro->nmPais}}" type="text" title="Nome do país" name="nmPais" id="nmPais{{$randId}}" class="form-control form-control-sm ">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-6 col-sm-12">
						<label class="label" for="cdPais{{$randId}}" >Cód. país</label>
						<input value="{{$registro->cdPais}}" id="cdPais{{$randId}}" title="Código do país " type="text" name="cdPais" class="form-control form-control-sm ">
					</div>
