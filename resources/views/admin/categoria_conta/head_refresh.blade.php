	...
	<div class="row">
		<div class="col-md-12">	
			<nav aria-label="breadcrumb" class="my-2">
				<ol class="breadcrumb">
					<li class="breadcrumb-item active"><a href="{{route('categoria_conta.index')}}">Inicio</a></li>
					<li class="breadcrumb-item desable" aria-current="page"><a >Lista de categoria de contas</a></li>
				</ol>
			</nav>
		</div>
	</div>
			...
			@php
				...
				$acoes 		= [
					...
					[
						...
						'href'      =>''.route('categoria_conta.create').'',
						'class'     =>'btn btn-md btn-outline-primary mr-2 mb-sm-1',
						'style'     =>'',
	...
	<script type="text/javascript">
		...
		@php 
			...
			if(! isset($modifyUrlTitle)){
				...
				@endphp
					Utilitarios.modifyUrlWithoutReload('/categoria_conta/head', 'caixas')
				@php
			}
		@endphp
