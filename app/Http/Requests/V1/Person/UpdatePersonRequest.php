...
class UpdatePersonRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'documento' => 'required|string|min:11|max:14|unique:App\Pessoa,documento,' . $this->route('id'),
            ...
            'endereco.complemento' => 'sometimes|nullable|string|min:0|max:255',
            ...
            'contatos.*.importancia' => 'sometimes|in:principal,secundario',
