...
use App\Http\Requests\V1\WorkOrder\Actions\AddItemWorkOrderRequest;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\DB;

class AddItemWorkOrderController extends Controller
{
    ...
    public function __invoke(AddItemWorkOrderRequest $request, $id): JsonResponse
    {
        try {
            ...
            return ApiResponseClass::sendRequest($result, 'Item added to WorkOrder successfully', JsonResponse::HTTP_OK);
