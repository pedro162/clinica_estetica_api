...
use App\Http\Requests\V1\WorkOrder\UpdateWorkOrderRequest;
use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\DB;

class UpdateWorkOrderController extends Controller
{
    ...
    public function __invoke(UpdateWorkOrderRequest $request, $id): JsonResponse
    {
        try {
            ...
            $requestData['id'] = $id;
            $this->service->update(CreateWorkOrderCommand::build($requestData));
