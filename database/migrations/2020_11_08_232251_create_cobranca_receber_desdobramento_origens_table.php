...
class CreateCobrancaReceberDesdobramentoOrigensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cobranca_receber_desdobramento_origens', function (Blueprint $table) {
            $table->id();
    ...
    */
    ...
    {
        Schema::dropIfExists('cobranca_receber_desdobramento_origens');
    }
}
